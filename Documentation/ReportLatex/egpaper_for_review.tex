...
%%%%%%%%% TITLE
\title{Deep Learning Architectures for Structural Damage Detection; Project Report: CS 7643}
...
The dataset has been divided into eight subsets of scene level, damage state, spalling condition, material type, collapse mode, component type, damage level, and damage type (publicly available). 
...
\hline\hline
Hossein Daneshvar & Data Creation and Implementation & Scraped the dataset for this project and trained the CNN of the encoder. Implemented attention mechanism to improve results. \\
Mahshid Jafar Pour & Implementation and Analysis & Trained the LSTM of the encoder and analyzed the results. Analyzed effect of number of nodes in hidden state.  Implemented Convolutional LSTM. \\
\hline
\end{tabular}
\end{center}
